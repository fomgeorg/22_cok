...
let mainQuestions = [
    {
        text: 'Во время делового совещания ваш сотрудник «вышел из себя», не принимая ваших замечаний по поводу очередного проекта. Выберите, к какому типу участников обсуждения он относится.',
        right: [1,],
        type: 1,
        points: 100,
        answers: ['Всезнайка','Спорщик','Словоохотливый', 'Негативист'],
    },
];
