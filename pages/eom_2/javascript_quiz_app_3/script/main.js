...
let mainQuestions = [
    {
        text: 'Выберите, какие из предложенных определений понятия менеджмент верные. <br> <span style="font-size: 25px; color: grey; font-weight: 700;">(Отметьте все правильные варианты ответа)</span>',
        right: [0,3,5],
        type: 3,
        points: 100,
        answers: ['понятие, полностью соответствующее понятию «управление» не зависимо от природы и особенностей объекта управления', 'умение точно в  срок составлять документы и отправлять по электронной почте по указанию руководителя', 'наука об  управлении финансовыми потоками  предприятия', 'умение добиваться поставленных целей, направляя труд, интеллект и мотивы поведения людей','понятие, являющиеся синонимом «бизнес»','совокупность  методов, принципов  и средств управления организациями с целью обеспечения  высокой эффективной  работы',],
    },
];
